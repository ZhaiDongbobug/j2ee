    ...
    <c:forEach items="${heros}" var="hero" varStatus="st">
        ...
        <nav>
          <ul class="pager">
            ...
            <li><a href="listHero?start=0">首  页</a></li>
            <li><a href="listHero?start=${pre}">上一页</a></li>
            <li><a href="listHero?start=${next}">下一页</a></li>
            <li><a href="listHero?start=${last}">末  页</a></li>
          </ul>           
        </nav>
...
<div style="margin:50px auto; width:300px">
    <form action="addHero" method="post">
        ...
        hp:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="hp" value="${hero.hp}"> <br><br>
        damage:&nbsp;<input name="damage" value="${hero.damage}"> <br><br>
		<br>
